...
# -*- coding: utf-8 -*-
"""
Script to download Qwen2.5 GGUF model for Bangla language support
"""
...
def download_qwen_gguf_model():
    """Download the Qwen2.5-0.5B-Instruct-GGUF model for Bangla language support"""
    print("Starting download of Qwen2.5-0.5B-Instruct-GGUF model for Bangla language support...")
    ...
    repo_id = "pedalnomica/Qwen2.5-0.5B-Instruct-GGUF-q2_k"  # Smaller GGUF model
